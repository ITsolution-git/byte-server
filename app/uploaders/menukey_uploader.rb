class MenukeyUploader < CarrierWave::Uploader::Base
  ...
  def image
    begin
      ...
      # image.quantize!
        Piet.optimize(model.send(mounted_as).path, :quality => 40)
      end
  ...
  def extension_white_list
     %w(bmp jpg jpeg png tiff max gif)
  end
